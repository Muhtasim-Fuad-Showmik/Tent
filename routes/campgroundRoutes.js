...
router.route('/')
    ...
    .post(isLoggedIn, validateCampground, catchAsync(campgroundController.createCampground)); // Link for uploading the data collected from the form adding a new campground.
...
router.route('/:id')
    ...
    .put(isLoggedIn, isAuthor, validateCampground, catchAsync(campgroundController.updateCampground)) // Link for submission of updated data for the campground.
